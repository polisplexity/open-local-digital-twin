...
import { Activity, BookOpen, Compass, FileText, Grid, Layers, Map, Settings, Users } from 'react-feather'
          ...
          <div className="hk-toolbar">
            <Nav as="ul" className="nav-light">
              <Nav.Item className="nav-link">
                <Button as={Link} href="/theory" variant="flush-dark" className="btn-icon btn-rounded flush-soft-hover">
              ...
              <Nav.Item className="nav-link">
                <Button as={Link} href="/docs" variant="flush-dark" className="btn-icon btn-rounded flush-soft-hover">
              ...
              <Nav.Item className="nav-link">
                <Button as={Link} href="/admin" variant="flush-dark" className="btn-icon btn-rounded flush-soft-hover">
