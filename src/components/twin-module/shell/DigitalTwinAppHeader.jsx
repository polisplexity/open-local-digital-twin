  ...
  return (
    <header className="invoice-header">
      ...
      <div className="invoice-options-wrap">
        ...
        <Button as={Link} href="/docs" variant="flush-dark" className="btn-icon btn-rounded flush-soft-hover d-lg-inline-block d-none">
        ...
        <Dropdown>
          ...
          <Dropdown.Menu align="end">
            ...
            <Dropdown.Item as={Link} href="/analytical-map">Go to Analytical Map</Dropdown.Item>
            <Dropdown.Item as={Link} href="/city-3d">Go to City 3D</Dropdown.Item>
            <Dropdown.Item as={Link} href="/civic-xr">Go to Civic XR</Dropdown.Item>
            <div className="dropdown-divider" />
            <Dropdown.Item as={Link} href="/theory">Theory</Dropdown.Item>
            <Dropdown.Item as={Link} href="/docs">Docs</Dropdown.Item>
            <Dropdown.Item as={Link} href="/admin">Admin</Dropdown.Item>
          </Dropdown.Menu>
        </Dropdown>
